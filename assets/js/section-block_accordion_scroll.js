/******/ (() => { // webpackBootstrap
/*!*******************************************************!*\
  !*** ./src/scripts/section/block_accordion_scroll.js ***!
  \*******************************************************/
document.addEventListener('DOMContentLoaded', function () {
  ...
  function toggleItem(index) {
    ...
    if (!isOpen) {
      ...
      var icon = targetItem.querySelector('.icon');
      if (icon) {
  ...
  allItems.forEach(function (item) {
    var button = item.querySelector('[data-toggle]');
    var title = item.querySelector('.title[data-toggle]');
