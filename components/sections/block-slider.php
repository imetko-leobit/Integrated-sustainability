...
$block_slider_heading_level = $block_slider_heading_level ?? 2;
$pillar_carousel_card_heading_level = $pillar_carousel_card_heading_level ?? 4;
...
<section class="block-slider" id="pillar1">
  <div class="block-slider__wrapper">
    ...
    <div class="block-slider__description block-slider__col--text">
      ...
      <div class="heading">
        <?php render_heading($pillar_title, $block_slider_heading_level, 'title title--h1'); ?>
      </div>
      ...
      <div class="pillar-carousel js-pillar-carousel" data-total-slides="<?php echo $total_slides; ?>">
        ...
        <div class="pillar-carousel-card <?php echo $item['active'] ? 'is-active' : ''; ?>"
          ...
          <a class="pillar-carousel-card__content-wrapper" href="<?php echo $item['link']; ?>"
            ...
            <?php render_heading($item['title'], $pillar_carousel_card_heading_level, 'pillar-carousel-card__title pillar-carousel-card__title--h4'); ?>
