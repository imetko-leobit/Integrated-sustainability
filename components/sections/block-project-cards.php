...
<section class="block-project-cards js-project-card-rotator" data-rotation-interval="7000">
  ...
  <div class="block-project-cards__buttons">
    <button class="btn block-project-cards__button">
      <span>More Insights</span>

      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="mask0_11871_45884" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
        <rect width="24" height="24" fill="#D9D9D9"/>
        </mask>
        <g mask="url(#mask0_11871_45884)">
    ...
    <button class="btn btn--gradient">
      <span>Full Insights Library</span>
    </button>
  </div>
</section>
