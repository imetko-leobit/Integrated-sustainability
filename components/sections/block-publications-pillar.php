...
<link rel="stylesheet" href="../assets/css/section-block_publications_pillar.css" />

<section class="block-publications-pillar">
  ...
  <div class="publications" id="publications">
    <?php if ($card): ?>
    <div class="additional-card laptop-up">
      <?php
    include('../components/elements/pillar-card.php');
    ?>
    </div>
