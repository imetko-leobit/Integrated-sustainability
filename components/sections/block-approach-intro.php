...
$block_approach_intro_heading_level = $block_approach_intro_heading_level ?? 3;
...
<section class="block-approach-intro<?php echo $modifier_class; ?>">
  <div class="block-approach-intro__wrapper">
    ...
    <div class="block-approach-intro__col block-approach-intro__col--text">
      ...
      <div class="heading">
        <?php render_heading($approach_heading_title, $block_approach_intro_heading_level, 'title title--h2', [], true); ?>
      </div>
