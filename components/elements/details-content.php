...
<?php
    ...
    $details_content_heading_level = $details_content_heading_level ?? 4;
    include_once(__DIR__ . '/../helpers/heading.php');
?>

<div class="details-content">
  <?php if ($details_title1): ?>
  <?php render_heading($details_title1, $details_content_heading_level, 'title title--h3'); ?>
  <?php endif; ?>
  ...
  <?php render_heading($details_title2, $details_content_heading_level, 'title title--h3'); ?>
  <?php endif; ?>
