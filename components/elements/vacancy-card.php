<?php
    $vacancy_card_heading_level = $vacancy_card_heading_level ?? 4;
...
<div class="vacancy-card">
  <div class="vacancy-card__content">
    <?php render_heading($vacancy_card_title, $vacancy_card_heading_level, 'title title--h3 vacancy-card__title'); ?>
