      ...
      <div class="floating-filter-panel__content" data-current-level="0">
        ...
        <div id="filter-level-industries" class="main-menu__col main-menu__col--level-1 submenu" data-level="1" data-filter-key="industries">
          ...
          <ul class="navbar-nav mobile-subcategory-nav">
            ...
            <li class="nav-item has-submenu" data-target="filter-level-industries-environmental">
          ...
          <div class="submenu-subcategory desktop-subcategory">
            <div class="submenu-subcategory__header">
              <label class="submenu-subcategory__header-label" for="filter-ind-desktop-metals-all">
                <input type="checkbox" id="filter-ind-desktop-metals-all" class="filter-checkbox desktop-subcategory-all-checkbox" tabindex="-1" aria-label="Select all Metals &amp; Mining">
                Metals &amp; Mining
              </label>
            </div>
            <ul class="navbar-nav">
          ...
          <div class="submenu-subcategory desktop-subcategory">
            <div class="submenu-subcategory__header">
              <label class="submenu-subcategory__header-label" for="filter-ind-desktop-env-all">
                <input type="checkbox" id="filter-ind-desktop-env-all" class="filter-checkbox desktop-subcategory-all-checkbox" tabindex="-1" aria-label="Select all Environmental">
                Environmental
              </label>
            </div>
            <ul class="navbar-nav">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <label class="nav-link" for="filter-ind-m-gold">
                <input type="checkbox" id="filter-ind-m-gold" name="industries[]" value="gold-mining" class="filter-checkbox">
                gold mining
              </label>
            </li>
            <li class="nav-item">
          ...
          <ul class="navbar-nav">
            <li class="nav-item">
              <label class="nav-link" for="filter-ind-m-environmental">
                <input type="checkbox" id="filter-ind-m-environmental" name="industries[]" value="environmental" class="filter-checkbox">
                environmental
              </label>
            </li>
            <li class="nav-item">
